...
export default function Module5() {
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-text-main-light dark:text-text-main-dark antialiased overflow-x-hidden pb-24 min-h-screen">
      ...
      <nav className="fixed bottom-0 w-full bg-white/90 dark:bg-surface-dark/95 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800 pb-safe pt-2 z-50">
        <div className="flex justify-around items-center px-2 pb-5 pt-1">
          <Link to="/" className="flex flex-col items-center gap-1 p-2 text-gray-400 hover:text-primary dark:hover:text-blue-300 w-16">
            <span className="material-symbols-outlined">home</span>
            <span className="text-[10px] font-medium">Início</span>
          </Link>
          <button className="flex flex-col items-center gap-1 p-2 text-primary dark:text-blue-400 w-16">
            <span className="material-symbols-outlined filled">school</span>
            <span className="text-[10px] font-medium">Aulas</span>
          </button>
          <button className="flex items-center justify-center -mt-6 size-14 rounded-full bg-primary text-white shadow-lg shadow-primary/40 hover:scale-105 transition-transform">
            <span className="material-symbols-outlined text-2xl">add</span>
          </button>
          <button className="flex flex-col items-center gap-1 p-2 text-gray-400 hover:text-primary dark:hover:text-blue-300 w-16">
